...
export default function SearchRepositorySearchBar(props: any) {
  ...
  // pass repository back to parent component
  React.useEffect(() => {
    props.onSelectedRepository(selectedRepository);
  }, [selectedRepository, props]);
